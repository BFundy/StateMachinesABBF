...
public class MakeNavPointsABBF : StateABBF {

    public MakeNavPointsABBF(ABunchOfBoxesOnTheFloorSC stateController) : base(stateController) { }
    int maxPoints = 0;
    int numPointsMade = 0;
    public override void CheckTransitions()
    {
        ...
        {
            stateController.SetState(new PatrolStateABBF(stateController));
        }
    }
