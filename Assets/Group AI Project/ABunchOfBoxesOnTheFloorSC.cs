...
public class ABunchOfBoxesOnTheFloorSC : MonoBehaviour
{
    public GameObject navPointsParent;
    public StateABBF currentState;
    ...
    void Start()
    {
        ...
        SetState(new PatrolStateABBF(this));
    }
    ...
    public void SetState(StateABBF state)
    {
